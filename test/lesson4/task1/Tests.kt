...
class Tests {
    ...
    @Tag("Impossible")
    fun russian() {
        assertEquals("пятьсот тридцать одна тысяча семьсот семьдесят два", russian(531772))
        assertEquals("четыреста двенадцать тысяч восемьсот двадцать восемь", russian(412828))
